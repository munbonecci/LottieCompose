<h1 align="center">LottieCompose</h1> 

<p align="center">
This app was created to learn more about Android compose using Lottie Compose component.
</p>
...
```bash
git clone https://github.com/munbonecci/LottieCompose.git
```
...
- [Lottie Compose](https://github.com/airbnb/lottie/blob/master/android-compose.md) -For Lottie
